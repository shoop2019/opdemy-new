				...
				<div class="meow-row meow-featured-plugins">
					...
					<div class="meow-box meow-col meow-span_1_of_2 ">
						<ul class="">
							...
							<li><img src='<?= $this->common_url( 'img/wp-retina-3x.jpg' ) ?>' />
								<a href='https://meowapps.com/plugin/wp-retina-3x/'><b>WP Retina 3x</b></a>
								<?php echo $this->check_install( 'wp-retina-3x' ) ?><br />
